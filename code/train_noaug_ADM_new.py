...
def main():
    ...
    if args.use_pretrain:
        pre_train(labeled_trainloader, unlabeled_trainloader, model, outlier_detection_model, model, optimizer,
                  optimizer_beta, scheduler, criterion, sigmoid_criterion, 0, val_tune_loader, test_tune_loader, in_distribution_test_loader)
...
def pre_train(labeled_trainloader, unlabeled_trainloader, model, outlier_detection_model, EM_model, optimizer,
              optimizer_beta,
              scheduler, criterion, sigmoid_criterion, epoch, testloader, test_tune_loader, in_distribution_test_loader):
    global best_pre_acc
    global best_pre_f1
