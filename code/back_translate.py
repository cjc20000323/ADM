...
if __name__ == '__main__':
    ...
    seed = args.seed
    total_labels = max(test_labels) + 1
    ...
    if args.lan == 'de':
        translate_de(0,max_pos, path + 'de_seed{}_nlabels{}_in.pkl'.format(seed, args.n_labels))
    else:
        translate_ru(0,max_pos, path + 'ru_seed{}_nlabels{}_in.pkl'.format(seed, args.n_labels))
