...
#SBATCH -o mix_rcv1_cls_100_1_111_0.8.out               # 屏幕上的输出文件重定向到 test.out
...
python -u ./code/train_noaug_cls_extreme.py --gpu 0 --n-labeled 100 \
...
--lrmain 0.000005 --lrlast 0.0005 --seed 1 --cls DOC --is-cls True --extreme-path ./data/rcv1/
