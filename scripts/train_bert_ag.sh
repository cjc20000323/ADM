#!/bin/bash
#SBATCH -J bertagcls_100                # 作业名为 test
#SBATCH -o bert_ag_100_in_1.out               # 屏幕上的输出文件重定向到 test.out
#SBATCH -p inspur 
...
python -u ./code/normal_train.py --gpu 0,1,2 --n-labeled 100 --data-path ./data/agnews_csv/ \
