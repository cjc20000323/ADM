#!/bin/bash
#SBATCH -J back_translate                # 作业名为 test
#SBATCH -o back_translate_yh_10_de_in.out               # 屏幕上的输出文件重定向到 test.out
#SBATCH -p inspur
...
python ./code/back_translate_in.py --n_labels 10 --data-path ./data/yahoo_answers_csv/ --seed 0 --lan de --gpu 0,1,2,3
