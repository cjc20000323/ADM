...
#SBATCH -o mix_yh_100_reset_lofretry_in_1.out               # 屏幕上的输出文件重定向到 test.out
#SBATCH -p inspur 
...
python -u ./code/train_noaug.py --gpu 0,1 --n-labeled 100 --un-labeled 5000 \
--data-path ./data/yahoo_answers_csv/ --batch-size 4 --batch-size-u 8 --epochs 90 --val-iteration 100 \
--lambda-u 1 --T 0.5 --alpha 16 --mix-layers-set 7 9 12 \
