...
python -u ./code/train_noaug_ADM.py --gpu 0,1,2,3 --n-labeled 100 --un-labeled 5000 \
--data-path ./data/agnews_csv/ --batch-size 4 --batch-size-u 8 --epochs 40 --val-iteration 100 \
--lambda-u 1 --T 0.3 --alpha 16 --mix-layers-set 7 9 12 \
--lrmain 0.000005 --lrlast 0.0005 --seed 0 --theta-threshold 0.5
