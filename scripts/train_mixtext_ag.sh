...
#SBATCH -o mix_ag_100_reset_lofretry_in_1.out              # 屏幕上的输出文件重定向到 test.out
#SBATCH -p inspur 
...
python -u ./code/train_noaug.py --gpu 2,3 --n-labeled 100 --un-labeled 5000 \
--data-path ./data/agnews_csv/ --batch-size 4 --batch-size-u 8 --epochs 90 --val-iteration 100 \
