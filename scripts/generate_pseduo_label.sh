...
#SBATCH -o logs/generate_pseduo_label.out             # 屏幕上的输出文件重定向到 test.out
#SBATCH -p inspur
...
python -u ./code/generate_pseduo_label.py --gpu 0,1,2 --n-labeled 10 --un-labeled 5000 \
--data-path ./data/yahoo_answers_csv/ --batch-size 4 --batch-size-u 8 --epochs 40 --val-iteration 100 \
--lambda-u 1 --T 0.5 --alpha 16 --mix-layers-set 7 9 12 \
--lrmain 0.000005 --lrlast 0.0005 --seed 0 --cls MSP --is-cls True --save-path ./model/yh_10.pt
