...
#SBATCH -o logs/mix_yh_EM_100.out              # 屏幕上的输出文件重定向到 test.out
#SBATCH -p inspur
...
python -u ./code/train_noaug_cls_EM_model.py --gpu 2,3 --n-labeled 50 \
--data-path ./data/yahoo_answers_csv/ --batch-size 4 --batch-size-u 8 --epochs 20 --val-iteration 100 \
--lambda-u 1 --T 0.5 --alpha 16 --mix-layers-set 7 9 12 \
--lrmain 0.000005 --lrlast 0.0005 --seed 0 --cls MSP --is-cls True --save-path ./model/yh_50_new.pt
