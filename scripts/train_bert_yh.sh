#!/bin/bash
#SBATCH -J bertyh100              # 作业名为 test
#SBATCH -o bert_yh_10_in.out               # 屏幕上的输出文件重定向到 test.out
#SBATCH -p inspur
...
python -u ./code/normal_train.py --gpu 2,3 --n-labeled 10 --data-path ./data/yahoo_answers_csv/ \
