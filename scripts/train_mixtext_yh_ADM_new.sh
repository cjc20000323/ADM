...
python -u ./code/train_noaug_ADM.py --gpu 0,1 --n-labeled 10 --un-labeled 5000 \
--data-path ./data/yahoo_answers_csv/ --batch-size 4 --batch-size-u 8 --epochs 100 --val-iteration 10 \
--lambda-u 1 --T 0.5 --alpha 16 --mix-layers-set 7 9 12 \
