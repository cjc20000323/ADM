...
python -u ./code/train_noaug_ADM_new_min_max_loss.py --gpu 0,1 --n-labeled 50 --un-labeled 5000 \
...
--lrmain 0.000005 --lrlast 0.0005 --seed 0 --theta-threshold 0.25 --pretrain-inititeration 100 --pretrain-afteriteration 100 --use-pretrain
