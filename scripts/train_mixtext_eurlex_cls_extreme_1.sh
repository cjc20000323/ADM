...
#SBATCH -o mix_eurlex_cls_10_2_0.51.out               # 屏幕上的输出文件重定向到 test.out
#SBATCH -p inspur --gres=gpu:A100:1
...
python -u ./code/train_noaug_cls_extreme_1.py --gpu 0 --n-labeled 10 \
...
--lrmain 0.000005 --lrlast 0.0005 --seed 2 --cls DOC --is-cls True --extreme-path ./data/eurlex/
