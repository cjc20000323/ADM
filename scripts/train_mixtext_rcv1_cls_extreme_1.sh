...
#SBATCH -o mix_rcv1_cls_50_4_0.7.out               # 屏幕上的输出文件重定向到 test.out
...
python -u ./code/train_noaug_cls_extreme_1.py --gpu 0 --n-labeled 50 \
...
--lrmain 0.000005 --lrlast 0.0005 --seed 4 --cls DOC --is-cls True --extreme-path ./data/rcv1/
