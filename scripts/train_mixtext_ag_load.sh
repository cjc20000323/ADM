...
#SBATCH -o mix_ag_classification_10_load.out               # 屏幕上的输出文件重定向到 test.out
#SBATCH -p inspur
...
python ./code/train_noaug_cls_load_model.py --gpu 0,1 --n-labeled 10 \
--data-path ./data/agnews_csv/ --batch-size 1 --batch-size-u 1 --epochs 20 --val-iteration 1000 \
--lambda-u 1 --T 0.3 --alpha 16 --mix-layers-set 7 9 12 \
--lrmain 0.000005 --lrlast 0.0005 --seed 0 --cls LMCL --is-cls False
