...
#SBATCH -o mix_ag_cls_10_case_study_2.out               # 屏幕上的输出文件重定向到 test.out
#SBATCH -p dell --gres=gpu:V100:4
#SBATCH -w dell-gpu-32
...
python -u ./code/train_noaug_cls_case_study.py --gpu 0,1,2,3 --n-labeled 10 \
