...
#SBATCH -o mix_eurlex_EM_50_2.out               # 屏幕上的输出文件重定向到 test.out
#SBATCH -p inspur --gres=gpu:A100:2
#SBATCH -w inspur-gpu-14
...
python -u ./code/train_noaug_cls_EM_extreme_model.py --gpu 0,1 --n-labeled 50 \
...
--lrmain 0.000005 --lrlast 0.0005 --seed 2 --cls LMCL --is-cls True --extreme-path ./data/eurlex/
