...
#SBATCH -o mix_db_50_reset_LMCL_lofretry_53.out               # 屏幕上的输出文件重定向到 test.out
#SBATCH -p inspur 
...
python -u ./code/train_noaug_cls.py --gpu 2,3 --n-labeled 50 \
--data-path ./data/dbpedia_csv/ --batch-size 8 --batch-size-u 8 --epochs 20 --val-iteration 100 \
--lambda-u 1 --T 0.5 --alpha 16 --mix-layers-set 7 9 12 \
--lrmain 0.000005 --lrlast 0.0005 --seed 1 --cls LMCL --is-cls True
